...
namespace artificially_infused.Controllers.game
{
    public class PromptsRepository
    {
        public List<string> Prompts = new List<string>
        {
            ...
            "A baby {ANIMAL} picking its nose and hiding it behind {LOCATION}.",
            ...
            "A robot is teaching a group of { NOUNS} how to {VERB} in a disco.",
            "An old man eating way too much { FOOD} while dancing the macarena.",
            "Flying {ANIMAL} wearing a top hat and sipping a cup of tea while being chased by a fleet of UFOs.",
            "The {ANIMAL} party has a strict dress code – feathered tuxedos and tiny top hats are a must for all attendees!",
            ...
            "The 'Terrible Towel Tango' is a Pittsburgh dance competition where participants must wear {CLOTHING} while dancing.",
            ...
            "A {ANIMAL} wearing sunglasses and riding a {NOUN}.",
            "A pizza flying in outer space with {FICTIONAL_CHARACTER}.",
            "A {ADJECTIVE} giraffe playing basketball against a {ANIMAL}.",
            "A muppet doing stand-up comedy for an audience of {NOUN} clones.",
            "A superhero {ANIMAL} saving the day in {FOOD} city.",
            "A grumpy-looking {FOOD} attending a birthday party for llamas.",
            "A {ANIMAL} blowing out the candles on the birthday cake.",
            ...
            "A ninja {ANIMAL} practicing martial arts in {ADJECTIVE} jungle.",
            "A late night disco party with {NOUN} and {ANIMAL}.",
            "A sneezing elephant creating a huge {FOOD} explosion.",
            "A {NOUN} having a tea party stuffed animals.",
            "A sassy {ANIMAL} doing goat yoga in a peaceful meadow.",
            ...
            "A karate-chopping {ANIMAL} in a martial arts tournament.",
            "A friendly ghost offering {NOUN} to kids.",
            "A slimy snail racing a {ANIMAL} at the {LOCATION}.",
            "A scorching hot cup of coffee participating in a marathon with {NOUN}.",
            "A group of {ANIMAL} friends roasting each other over a {ADJECTIVE} campfire under the moon.",
            "A {NOUN} playing a magic violin made of {ADJECTIVE} {FOOD}",
            "A hairless cat detective solving the mystery of the {ADJECTIVE} {NOUN}",
            "A {ANIMAL} playing an electric guitar underwater with {NOUN}",
            "A talking {ANIMAL} hosting a late-night talk show about {NOUN}",
            "A {ADJECTIVE} scientist conducting experiments on {ANIMAL} in a laboratory in the mountains.",
            "A group of {ADJECTIVE} {FOOD} creating the ultimate KISS cover band",
            "A {ANIMAL} taking a bubble bath in a boiling tub of oil and {NOUN}.",
            ...
            "A rockstar broccoli shredding it on a guitar in front of a cheering crowd of {ANIMAL}.",
            ...
            "A {ANIMAL} on a tightrope, balancing on a string of dental floss.",
            ...
            "A sushi chef {ANIMAL} creating {FOOD} with ninja-like precision.",
            "A charismatic slice of buffalo chicken pizza {VERB} a cooking show for {NOUN}.",
            "Forest Gump wearing a {ADJECTIVE} {ANIMAL} mask. ",
            ...
            "A group of {ANIMAL} exploring a {ADJECTIVE} temple filled with deadly {NOUN}.",
            "James Bond {VERB} into a {ADJECTIVE} underwater base to fight {NOUN}.",
            "A martial arts {FOOD} confronting an army of robotic {ANIMAL} in a neon-lit dojo.",
            "A {LOCATION} survivor leading a rebellion against a tyrannical {ANIMAL} overlord.",
            ...
            "A {ADJECTIVE} {ANIMAL} battling a giant monster in the heart of a bustling {LOCATION}.",
            ...
            "A team of crack {ANIMAL} mercenaries rescuing hostages from a high-rise skyscraper under siege.",
            ...
            "A team of {ANIMAL} archaeologists facing ancient curses and {ADJECTIVE} entities in a tomb raid.",
            ...
            "A mountain climber scaling a {ADJECTIVE} peak while pursued by an international crime syndicate of {ANIMAL}.",
            "A submarine race against rival factions to recover a {ADJECTIVE} {NOUN} from the ocean depths.",
            "A team of ex-military mercenary {ANIMAL} hired for a covert mission in a war-torn {LOCATION}.",
            ...
            "A deep-sea expedition uncovering ancient {ANIMAL} in the uncharted depths of {LOCATION}.",
            "A {ADJECTIVE} mercenary tracking down a warlord through a sun-scorched wilderness of {LOCATION}.",
            "A space archaeologist discovering a {ADJECTIVE} alien civilization of {ANIMAL} on an isolated planet.",
            ...
            "A {FOOD} riding a {ANIMAL} in outer space.",
            "A {ANIMAL} having a picnic with a group of {NOUN}.",
            "A {LOCATION} playing {NOUN} in a tropical paradise.",
            "An {ANIMAL} giving a {LOCATION} a piggyback ride.",
